...
franchiseRouter.docs = [
  ...
  },
  {
    ...
    requiresAuth: true,
    description: `List a user's franchises. The auth cookie must be sent with the request.`,
    example: `curl localhost:3000/api/franchise/4`,
  ...
  },
  {
    ...
    path: '/api/franchise',
    requiresAuth: true,
    description: 'Create a new franchise. Admin role required.',
    example: `curl -X POST localhost:3000/api/franchise -H 'Content-Type: application/json' -d '{"name": "pizzaPocket", "admins": [{"email": "f@jwt.com"}]}'`,
  ...
  },
  {
    ...
    requiresAuth: true,
    description: `Delete a franchise. Admin role required.`,
    example: `curl -X DELETE localhost:3000/api/franchise/1`,
  ...
  },
  {
    ...
    requiresAuth: true,
    description: 'Create a new franchise store. Franchisee or Admin role required.',
    example: `curl -X POST localhost:3000/api/franchise/1/store -H 'Content-Type: application/json' -d '{"franchiseId": 1, "name":"SLC"}'`,
  ...
  },
  {
    ...
    requiresAuth: true,
    description: `Delete a store. Franchisee or Admin role required.`,
    example: `curl -X DELETE localhost:3000/api/franchise/1/store/1`,
